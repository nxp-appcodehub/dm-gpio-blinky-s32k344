...
## GPIO Blinking LED Demo for FRDM-A-S32K344
...
The onboard RGB LED will cycle through each color, toggling On/Off:
 - Red
 - Blue
 - Green

## 5. Support<a name="step5"></a>
For general technical questions related to NXP microcontrollers, please visit the [NXP Community Forum](https://community.nxp.com/).
#### Project Metadata
...
<!----- Categories ----->
[![Category badge](https://img.shields.io/badge/Category-GPIO-yellowgreen)](https://mcuxpresso.nxp.com/appcodehub?category=gpio)
[![Category badge](https://img.shields.io/badge/Category-CLOCK-yellowgreen)](https://mcuxpresso.nxp.com/appcodehub?category=clock)
